...
\usepackage{lltjext}% for \parbox<t> (vertical writing test)
...
\section*{6. 縦書きでの自動基準（\texttt{\textbackslash RotTate}）}
\noindent\parbox<t>{12\zw}{%
  甲乙丙\maru{\Rrnum{1}}\maru{\Rrnum{3}}\maru{\Rrnum{8}}\maru{8}丁戊\kakko{\Rrnum{4}}}
