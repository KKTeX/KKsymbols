...
\textbf{Naturally, these commands also work correctly in vertical writing environments. But only when they include math-mode (in vertical mode), they don't.} Also when you want to typeset \maru{あ}, for instance, in vertical mode, you should use \verb|\RotTate| command. 
