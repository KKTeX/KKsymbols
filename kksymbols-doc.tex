...
\begin{itemize}
  ...
  \item \textbf{v2.1.2 (2026/02/17)} --- The effects are applied when the argument of a command subject to the \KKverb|tsumesuji| option—after expansion—is a numeric string of two or more digits and contains the digit ``1''.
\end{itemize}
