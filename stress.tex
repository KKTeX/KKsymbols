% stress.tex — コーナーケース総当たりストレステスト（v2.2.0）
% コンパイル: lualatex -interaction=nonstopmode stress.tex
\documentclass{jlreq}
...
\newjfontfamily{\gthiraj@pre}{HiraKakuPro-W3}[BoldFont=HiraKakuPro-W6]
\newfontfamily{\gthira@pre}{HiraKakuPro-W3}[BoldFont=HiraKakuPro-W6]
...
% "Package graphics Error: Division by 0" を出す（出力は継続）。要修正判断。
